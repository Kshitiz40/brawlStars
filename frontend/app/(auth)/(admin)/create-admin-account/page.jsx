...
import {registerAdmin} from "@/app/_components/State/Authentication/Action";
...
const createAdmin = () => {
    ...
    const onCreateAccount=(e) => {
        ...
        dispatch(registerAdmin({adminData:formData,router}))
    ...
    return (
        <div className='flex items-baseline justify-center my-20'>
            <div className='flex flex-col items-center justify-center p-10 border-2 rounded-2xl border-gray-200'>
                ...
                <h2 className='font-bold text-3xl'>Create Admin</h2>
